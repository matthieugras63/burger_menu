...
<body>
  ...
  <div id="menu_open">
    <div>
      <div>
        <ul>
          <li><a href="#" class="menu_first_item">Enlace 1</a></li>
          <li><a href="#" class="menu_second_item">Enlace 2</a></li>
          <li><a href="#" class="menu_third_item">Enlace 3</a></li>
          <li><a href="#" class="menu_fourth_item">Enlace 4</a></li>
        </ul>
      </div>
    ...
    <div>
      ...
      <div>
        <span class="menu_first_item">Cambiar <br>de idioma</span>
        <span>
          <hr />
        </span>
        <ul>
